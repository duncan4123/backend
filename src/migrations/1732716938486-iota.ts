...
export class Iota1732716938486 implements MigrationInterface {
    name = 'Iota1732716938486'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."tvl_blockchaintype_enum" AS ENUM('ethereum', 'sei-network', 'celo', 'blast', 'iota-evm')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."tvl_exchangeid_enum" AS ENUM('ethereum', 'sei', 'celo', 'blast', 'iota')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."total-tvl_blockchaintype_enum" AS ENUM('ethereum', 'sei-network', 'celo', 'blast', 'iota-evm')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."total-tvl_exchangeid_enum" AS ENUM('ethereum', 'sei', 'celo', 'blast', 'iota')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."blocks_blockchaintype_enum" AS ENUM('ethereum', 'sei-network', 'celo', 'blast', 'iota-evm')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."tokens_blockchaintype_enum" AS ENUM('ethereum', 'sei-network', 'celo', 'blast', 'iota-evm')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."tokens_exchangeid_enum" AS ENUM('ethereum', 'sei', 'celo', 'blast', 'iota')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."tokens-traded-events_blockchaintype_enum" AS ENUM('ethereum', 'sei-network', 'celo', 'blast', 'iota-evm')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."tokens-traded-events_exchangeid_enum" AS ENUM('ethereum', 'sei', 'celo', 'blast', 'iota')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."pairs_blockchaintype_enum" AS ENUM('ethereum', 'sei-network', 'celo', 'blast', 'iota-evm')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."pairs_exchangeid_enum" AS ENUM('ethereum', 'sei', 'celo', 'blast', 'iota')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."strategies_blockchaintype_enum" AS ENUM('ethereum', 'sei-network', 'celo', 'blast', 'iota-evm')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."strategies_exchangeid_enum" AS ENUM('ethereum', 'sei', 'celo', 'blast', 'iota')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."quotes_blockchaintype_enum" AS ENUM('ethereum', 'sei-network', 'celo', 'blast', 'iota-evm')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."historic-quotes_blockchaintype_enum" AS ENUM('ethereum', 'sei-network', 'celo', 'blast', 'iota-evm')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."activities_blockchaintype_enum" AS ENUM('ethereum', 'sei-network', 'celo', 'blast', 'iota-evm')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."activities_exchangeid_enum" AS ENUM('ethereum', 'sei', 'celo', 'blast', 'iota')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."trading-fee-ppm-updated-events_blockchaintype_enum" AS ENUM('ethereum', 'sei-network', 'celo', 'blast', 'iota-evm')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."trading-fee-ppm-updated-events_exchangeid_enum" AS ENUM('ethereum', 'sei', 'celo', 'blast', 'iota')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."strategy-updated-events_blockchaintype_enum" AS ENUM('ethereum', 'sei-network', 'celo', 'blast', 'iota-evm')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."strategy-updated-events_exchangeid_enum" AS ENUM('ethereum', 'sei', 'celo', 'blast', 'iota')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."voucher-transfer-events_blockchaintype_enum" AS ENUM('ethereum', 'sei-network', 'celo', 'blast', 'iota-evm')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."voucher-transfer-events_exchangeid_enum" AS ENUM('ethereum', 'sei', 'celo', 'blast', 'iota')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."strategy-created-events_blockchaintype_enum" AS ENUM('ethereum', 'sei-network', 'celo', 'blast', 'iota-evm')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."strategy-created-events_exchangeid_enum" AS ENUM('ethereum', 'sei', 'celo', 'blast', 'iota')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."strategy-deleted-events_blockchaintype_enum" AS ENUM('ethereum', 'sei-network', 'celo', 'blast', 'iota-evm')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."strategy-deleted-events_exchangeid_enum" AS ENUM('ethereum', 'sei', 'celo', 'blast', 'iota')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."pair-created-events_blockchaintype_enum" AS ENUM('ethereum', 'sei-network', 'celo', 'blast', 'iota-evm')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."pair-created-events_exchangeid_enum" AS ENUM('ethereum', 'sei', 'celo', 'blast', 'iota')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."pair-trading-fee-ppm-updated-events_blockchaintype_enum" AS ENUM('ethereum', 'sei-network', 'celo', 'blast', 'iota-evm')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."pair-trading-fee-ppm-updated-events_exchangeid_enum" AS ENUM('ethereum', 'sei', 'celo', 'blast', 'iota')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_e8b3d16260b7dea43e343e3366"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_488c5516e8c72b2686e744bfed"`);
        await queryRunner.query(`CREATE TYPE "public"."pair-trading-fee-ppm-updated-events_exchangeid_enum_old" AS ENUM('ethereum', 'sei', 'celo', 'blast')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."pair-trading-fee-ppm-updated-events_blockchaintype_enum_old" AS ENUM('ethereum', 'sei-network', 'celo', 'blast')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."pair-created-events_exchangeid_enum_old" AS ENUM('ethereum', 'sei', 'celo', 'blast')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."pair-created-events_blockchaintype_enum_old" AS ENUM('ethereum', 'sei-network', 'celo', 'blast')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."strategy-deleted-events_exchangeid_enum_old" AS ENUM('ethereum', 'sei', 'celo', 'blast')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."strategy-deleted-events_blockchaintype_enum_old" AS ENUM('ethereum', 'sei-network', 'celo', 'blast')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."strategy-created-events_exchangeid_enum_old" AS ENUM('ethereum', 'sei', 'celo', 'blast')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."strategy-created-events_blockchaintype_enum_old" AS ENUM('ethereum', 'sei-network', 'celo', 'blast')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."voucher-transfer-events_exchangeid_enum_old" AS ENUM('ethereum', 'sei', 'celo', 'blast')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."voucher-transfer-events_blockchaintype_enum_old" AS ENUM('ethereum', 'sei-network', 'celo', 'blast')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."strategy-updated-events_exchangeid_enum_old" AS ENUM('ethereum', 'sei', 'celo', 'blast')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."strategy-updated-events_blockchaintype_enum_old" AS ENUM('ethereum', 'sei-network', 'celo', 'blast')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."trading-fee-ppm-updated-events_exchangeid_enum_old" AS ENUM('ethereum', 'sei', 'celo', 'blast')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."trading-fee-ppm-updated-events_blockchaintype_enum_old" AS ENUM('ethereum', 'sei-network', 'celo', 'blast')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."activities_exchangeid_enum_old" AS ENUM('ethereum', 'sei', 'celo', 'blast')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."activities_blockchaintype_enum_old" AS ENUM('ethereum', 'sei-network', 'celo', 'blast')`);
        ...
        await queryRunner.query(`ALTER TABLE "activities" ADD CONSTRAINT "UQ_1a24b75ad87c83b0761f6e00135" UNIQUE ("blockchainType", "exchangeId", "strategyId", "action", "baseQuote", "baseSellToken", "baseSellTokenAddress", "quoteBuyToken", "quoteBuyTokenAddress", "buyBudget", "sellBudget", "buyPriceA", "buyPriceMarg", "buyPriceB", "sellPriceA", "sellPriceMarg", "sellPriceB", "timestamp", "txhash", "blockNumber")`);
        await queryRunner.query(`CREATE TYPE "public"."historic-quotes_blockchaintype_enum_old" AS ENUM('ethereum', 'sei-network', 'celo', 'blast')`);
        await queryRunner.query(`ALTER TABLE "historic-quotes" ALTER COLUMN "blockchainType" DROP DEFAULT`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."quotes_blockchaintype_enum_old" AS ENUM('ethereum', 'sei-network', 'celo', 'blast')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."strategies_exchangeid_enum_old" AS ENUM('ethereum', 'sei', 'celo', 'blast')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."strategies_blockchaintype_enum_old" AS ENUM('ethereum', 'sei-network', 'celo', 'blast')`);
        ...
        await queryRunner.query(`ALTER TABLE "strategies" ADD CONSTRAINT "UQ_ca3ef6c54f8acf3f8acd7e14e32" UNIQUE ("blockchainType", "exchangeId", "strategyId")`);
        await queryRunner.query(`CREATE TYPE "public"."pairs_exchangeid_enum_old" AS ENUM('ethereum', 'sei', 'celo', 'blast')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."pairs_blockchaintype_enum_old" AS ENUM('ethereum', 'sei-network', 'celo', 'blast')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."tokens-traded-events_exchangeid_enum_old" AS ENUM('ethereum', 'sei', 'celo', 'blast')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."tokens-traded-events_blockchaintype_enum_old" AS ENUM('ethereum', 'sei-network', 'celo', 'blast')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."tokens_exchangeid_enum_old" AS ENUM('ethereum', 'sei', 'celo', 'blast')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."tokens_blockchaintype_enum_old" AS ENUM('ethereum', 'sei-network', 'celo', 'blast')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."blocks_blockchaintype_enum_old" AS ENUM('ethereum', 'sei-network', 'celo', 'blast')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."total-tvl_exchangeid_enum_old" AS ENUM('ethereum', 'sei', 'celo', 'blast')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."total-tvl_blockchaintype_enum_old" AS ENUM('ethereum', 'sei-network', 'celo', 'blast')`);
        ...
        await queryRunner.query(`ALTER TABLE "total-tvl" ADD CONSTRAINT "UQ_7fe5b00781f6564ec055b4f88ab" UNIQUE ("blockchainType", "exchangeId", "timestamp")`);
        await queryRunner.query(`CREATE TYPE "public"."tvl_exchangeid_enum_old" AS ENUM('ethereum', 'sei', 'celo', 'blast')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."tvl_blockchaintype_enum_old" AS ENUM('ethereum', 'sei-network', 'celo', 'blast')`);
